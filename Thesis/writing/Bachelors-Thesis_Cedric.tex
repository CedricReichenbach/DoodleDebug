...
Navigation between nesting layers inside a pop-up is aided with bread crumbs~\cite{Krug00a}, which traces the currently inspected branch of the object graph (\figref{breadcrumbs}).
...
Thanks \DD's inspection feature, the summarized representation of an object can be held rather terse.
