...
Debugging by directly writing into source code may be easier and quicker than having to equip other debugging tools for a session\cite[p. 119]{The Practice of Programming}\todo{Resolve}.
