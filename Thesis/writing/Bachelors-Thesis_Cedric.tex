...
If the standard output of DoodleDebug does not fit a user's needs, it can be adjusted through one of the two described methods; the simpler \texttt{Doodleable} interface was used in this context by Alpha while solving the sorting problem.
