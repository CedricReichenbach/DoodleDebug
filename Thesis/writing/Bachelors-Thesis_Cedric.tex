...
\nes{So it wasn't a fair setup. You provided training for your tool, but not for the alternative.}
\meta{I beg to differ. All of them already had experience with Eclipse and debugging. They were free to use *any* way of debugging except DD, so experienced programmers should rather take advantages from this (null hypothesis). The whole point of letting them go through the DD tutorial was to somehow equalize the chances, i.e. teach them the mechanics of DD they should already know by heart for their favorite tool.
Do we need to explicitly explain this in the text?}
...
\meta{Last senctence of the "Posed Problems" introduction. Something like this?}

\subsection{Subjects}
\nes{Move this up.}\meta{Here?}
...
Ad-hoc textual prints of the subjects were unstructured for all subjects except Charlie \nes{Wtf is "unstructured"?} \meta{His structure is mentioned in the next paragraph, should we refer to that?}.
