...
As suggested by Buxton\cite{?}\todo{citation: P. 73-76}, we decided to start with an initial design phase, which later fades into implementation as soon as a reasonable concept is available.
