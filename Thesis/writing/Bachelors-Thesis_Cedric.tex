...
Thus, a \texttt{meta} tag needed to be set in order to suppress quirks or any other compatibility mode\footnote{\url{http://msdn.microsoft.com/en-us/library/jj676915\%28v=vs.85\%29.aspx}} \meta{You told me to also add this note to the paper. But we don't talk about this at all there...} \nes{Oh, ok then. Footnotes should be more than a link, though. What will I see when clicking?} and make sure the newest installed rendering engine is used for best-possible support, especially for CSS3 features.
