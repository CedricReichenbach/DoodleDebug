...
\meta{You wanted to mention the build number here. Well, I didn't really have a structured versioning before 1.0. Also, those are not publicly available (unless we move the whole git repo to github or whatever).}
...
Echo mentioned that he missed the feature to compare two objects from different points in time.
...
\todo{re-write "source code staring"}
