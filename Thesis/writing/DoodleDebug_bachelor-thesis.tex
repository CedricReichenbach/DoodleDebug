...
\subsubsection{Selecting Technology}
...
\subsubsection{Communication between Java Virtual Machines}
...
\subsubsection{Providing Code from Eclipse Plugin to Workspace}
\paragraph{What Is Provided to the User Workspace}
...
\subsubsection{Serialization for the Transport between VMs}
...
\subsubsection{Communication between Java and JavaScript}
\paragraph{From Java to JavaScript}
...
\paragraph{From JavaScript to Java}
...
\subsection{API}
\meta{Where should this part go?}
...
\subsection{Output}
\todo{text}
\subsubsection{Output format and rendering engine}
